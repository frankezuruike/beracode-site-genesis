        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-xl font-bold">BeraCode AI</span>
            </div>
            <p className="text-gray-300 mb-6 leading-relaxed">
              Revolutionizing development with AI-powered solutions. 
              We transform businesses through intelligent technology and innovative approaches.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} BeraCode AI Ltd. All rights reserved.
            </p>
